...
\begin{itemize}\itemsep1pt
	...
	\item \nameref{skill:Chymistry}---(Not in Beta)
	\item \nameref{skill:Climbing}
	\item \nameref{skill:Cooking}
	\item \nameref{skill:Crafting}
	\item \nameref{skill:Drill}---(Not in Beta)
	...
	\item \nameref{skill:Strategy}---(Not in Beta)
	\item \nameref{skill:Subterfuge}
	\item \nameref{skill:Surgery}
	\item \nameref{skill:Swimming}
	\item \nameref{skill:Tactics}---(Not in Beta)
\end{itemize}
