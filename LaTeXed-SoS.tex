...
\begin{quotation}
  {\small \emph{Mago laughed despite himself as he vaulted the barricade. The
      routing nomads were scrambling to reform in their makeshift wagon fort.
      Mago landed before a man struggling with the match of his arquebus. The
      man looked up. With an exultant whoop, Mago drew his saber and cut the
      man’s right arm off at the elbow in the same motion. The limb fell, its
      fingers still holding the powder-horn, and Mago walked past, pushing the
      man out of his way just as he began to scream at the stump of his own
      arm.} 

    \emph{A lancer approached, and Mago wove out of the way of the polearm,
      two-stepped forward, and snapped out with a cut that caught fingers
      between blade and haft, cleaving all of the digits from the spearman’s
      forward hand. He barked aloud in wordless triumph, and swept in to hammer
      aside a high blow from another swordsman. Grasping his foe by the collar,
      Mago saw his face. Little more than a child, brown eyes wide, mouth moving
      in wordless fear. Mago blinked, and then caved the boy’s head in with
      three terrible blows from the spiked pommel of his sword. He threw the
      corpse away, and flung himself into the melee, as his brothers closed the
      net. The slaughter was absolute, men who had raided and pillaged Dacian
      land for years died on their knees, begging for Dacian mercy.}

    \emph{Mago brought his sword down, cleaving a pleading nomad’s head down
      through to the teeth. He wrenched his sword free and flung his arms wide.
      There were no more left to kill. The Fighting Volkodavs howled in triumph
      on a mountain of corpses. A gunshot rang out. Mago heard someone scream.
      The voice sounded familiar.}

    \emph{Then he hit the ground. White-hot pain erupted from his upper thigh,
      where the bullet had struck him in the back. He realized that he was
      screaming, and all at once it hit him. The cold mud in his hair, on his
      face. The clawing agony in his leg. He knew that he would live, somehow.
      Limping for life, but alive. He forced open his eyes, through the tears of
      pain, and scanned the perimeter for the source. \textbf{Who?} He tried to
      breathe through gritted teeth, pain and fury foaming in his mouth.
      \textbf{Who shot me? I must know.} He felt a tooth crack as his eyes
      settled on the source of his ruin.}

    \emph{The one-armed man, pale from loss of blood and fading fast, grinned
      over the smoking barrel of his arquebus.}} 
\end{quotation}
...
\begin{table}[ht]
  ...
  \begin{tabu} spread 0pt {c l c c c X c c}
    ...
    6&Tier 4&140&15&15&Minor Noble/(100 gp, [3W])&30&10\\
...
\begin{longtabu} spread 0pt {lXX}
  ...
  Grit&Description&Example Advancement Threshold\\\toprule
...
\begin{table}[!hb] %LINK RACE TIERS
  \caption{Race Tiers}
  \label{tab:racetiers} 
  \begin{tabu}{ccX}
    PCP&Tier&Races\\\toprule
    1&Tier 1&\hyperref[sec:humans]{Human}, \hyperref[sec:goblins]{Goblin}\\
    2&Tier 2&\hyperref[sec:dwarves]{Dwarf}, \hyperref[sec:zells]{Zell}\\
    4&Tier 3&\nameref{sec:burdinadin}, \nameref{sec:ohanedin}\\
    6&Tier 4&\nameref{sec:orredin}\\
    8&Tier 5&\hyperref[sec:star-vampires]{Star Vampire}, \nameref{sec:sarturi-chosen}, \nameref{sec:genosian-paladin}, \nameref{sec:dessian-silver-guard}, Paleolithic Elf\\
  \end{tabu}
\end{table}
...
\subsection{Burdinadin}\label{sec:burdinadin} %BURDS NEED WORK
\begin{quote}
...
\subsection{Ohanedin}\label{sec:ohanedin}%OHANEDIN
\begin{quote}
...
\subsubsection*{Ecology} 
XXX 
\section{Ascended Humans}\label{sec:ascended-humans}
Ascended Humans, or ‘Ascendants’ are Human beings who have returned from death
changed. Their faith, dedication and willpower in life was such that they were
able to achieve a sort of reincarnation, returned to the mortal realm through
the patronage of a deity. Ascendants are the immortal servants of their patrons,
returned to see the will of their god done. No other race besides Humans can
Ascend, and this has been the subject of many serious inquiries as to the nature
of Humankind relative to the other races. The Orredin, for example, resolutely
believe that the Ascendants are proof that Humans are actually Din, and that
their Focus is dying. Whatever the case, the Ascendants exist. They are proof
that there is something in the Human spirit more powerful than death.  
...
\subsection{Genosian Paladin}\label{sec:genosian-paladin} 
\begin{quote}
  \emph{"God is Justice."}
...
---\quad Before a battle, any companion of the Chosen may don a bandana stained with the Chosen's blood. If they do so, they are considered part of that Chosen's ‘Band’ until the next time they remove the bandana. 
...
---\quad Wounds just seem to want to bleed more when a Chosen is on the battlefield. To increase the 
...
---\quad If a Sarturi Chosen is killed in battle, whoever struck the finishing blow gains a number of Faith 
...
Old Wound multiple times on the exact same part of your body, or take Prodigious
Strength twice to raise your character creation attribute caps by 4.  


Unless specified otherwise, a higher level of a Boon or Bane replaces the effects of its lower levels.
\clearpage
\section{Boons List}\vspace{-15pt}
\begin{longtabu} spread 0pt {X X X[-1,r]}
  \captionsetup{textformat=empty, labelformat=blank}
  \caption{List of Boons} \vspace{-15pt}
...
\begin{itemize}
\item [3:] You gain a +2 bonus to CHA when dealing with everyone, if your beauty
  is apparent. You gain a +4 bonus to CHA when dealing with characters who would
  find you sexually attractive. 
\item [6:] You cause carriage crashes. You gain a +3 bonus to CHA when dealing
  with everyone, if your beauty is apparent. You gain a +6 bonus to CHA when
  dealing with characters who would find you sexually attractive. Beauty of this
  caliber often comes with unwanted attention. 
\end{itemize}
...
A character cannot have True Grit at the same time as the \nameref{bane:Sheltered} Bane.
\begin{itemize}
...
knocked out or pass out from \nameref{sec:Blood Loss} or excessive Pain, you
...
competent and ambitious heroes than any other: you are a genuinely moral,
honest, and righteous person. Perhaps it's just in your nature, or perhaps you
were just raised well. You've got a conscience, a desire to help people, and
while you may not be a pacifist, you're no murderer, and you despise senseless
violence, drawing the sword only when necessary. This isn't an easy way to live.
Historically, paragons of morality were few and far between, and it has often
been said that ‘the good die young.’ 


If you ever act in an immoral, unnecessarily cruel or ruthless fashion, you must
pay the next 10 Arc Points you earn, as you are wracked by your conscience.
However, if you immediately act to try and make up for your moral transgression,
by making amends with the wronged or through atonement to society or God, this
loss is reduced to 5 Arc Points. 
...
History is the record of events both human and natural as chronicled throughout
the ages. History is a patchwork quilt of stories, accounts, perspectives and
guesswork that makes up the understanding that the present has of the past. How
closely history coincides with reality is always uncertain, but it provides the
foundation, the context for understanding current events and is thus
indispensable, even with its flaws. The History skill allows a character to have
or gain knowledge of a past event, people, place, culture, etc. When a character
encounters something which they might’ve heard about at some point in the past,
or upon which an understanding of history might shed some light or special
understanding, the GM may prompt them to make a History roll at an RS determined
by the obscurity of the event and the resources available to the character. 
\begin{longtabu} to \linewidth {X[1.5]X[-1,r]}
  \caption{History}
  \label{tab:History}\\
  \rowfont[c]{}Action &Base Attribute vs. RS or other effects\\\toprule
  \rowfont[c]{} Modifiers & Effects\\\cmidrule(lr){1-2} 
...
In Song of Swords, hunting has less to do with killing game and more to do with
getting near it in the first place. Obviously, this includes tracking, but it
also includes knowing how to hide your scent, how to control and entrap animals,
and how to make and disguise simple traps to capture or kill game. Obviously,
these skills aren’t useful just for hunting animals. People have been referred
to as ‘the most dangerous game’ for a reason, after all. 
...
must make a HLT check at RS 3 or gain the bane \nameref{bane:Brain
  Damage}~(major) 
...
\begin{table}[hb]
  ...
  \begin{tabu} to \linewidth {X[-1,c] X[-1,l]X[-2,c]X[c]X[3]}
    \rowfont[c]{}[W]ealth Spent&Asset Level &Withdraw Amount&Liquidated Value&Example\\\toprule
    1 &Minor &20 sp &6 gp (120 sp) &Small Farm, Small Business, Small Cattle Herd \\
...
%   \begin{tabu} spread 0pt {X[-2,c]X[2]X[-1,r]}
...
\begin{longtabu} spread 0pt {X[-2,c] X[c] X[c] X[-1,c]}
  ...
  \rowfont[c]{}Proficiency Level&Maneuver Tiers Unlocked&Talents Unlocked&Proficiency Point / Arc Point Cost\\\toprule
  1&	Core Maneuvers&	-&	1\\
...
brackets (i.e. 1 Primary [0]) that alter the CP of the Proficiencies in
question. %% This section needs to be clarified, wrt. cost of proficiencies
...
\subsection{Wrestling} %% Not yet added grapple fix
...
\vspace{-5pt}\begin{itemize}
  [itemsep=0.5mm]
\item \nameref{man:Deep Draw Cut}
\item \nameref{man:Pommel Strike}
\end{itemize}

\subsubsection{Tier 1 Maneuvers}
\vspace{-5pt}\begin{itemize}
  [itemsep=0.5mm]
\item \nameref{man:Dacian Rush}
\item \nameref{man:Arm Parry} [Superior]
\item \nameref{man:Pommel Strike} [Superior]
\item \nameref{man:Disarm} [Superior]
\end{itemize}
\subsubsection{Tier 2 Maneuvers}
Clinch [Superior]
...
\vspace{-5pt}\begin{itemize}
  [itemsep=0.5mm]
\item \nameref{man:Shield Bind}
\item \nameref{man:Deep Draw Cut}
\item \nameref{man:Riposte}
\item \nameref{man:Murder-Strike}
\item \nameref{man:Half-Sword}
\item \nameref{man:Quickdraw}
\item \nameref{man:Shield Bash} [Superior]
\item \nameref{man:Shield Beat} [Superior]
\item \nameref{man:Pommel Strike} [Superior]
\item \nameref{man:Simultaneous Parry/Attack}
\end{itemize}
\subsubsection{Tier 2 Maneuvers}
\vspace{-5pt}\begin{itemize}
  [itemsep=0.5mm]
\item \nameref{man:Beat} [Superior]
\item \nameref{man:Simultaneous Parry/Attack} [Superior]
\item \nameref{man:Disarm} [Superior]
\item \nameref{man:Hilt Push} [Superior]
\item \nameref{man:Push Cut} [Superior]
\item \nameref{man:Riposte} [Superior]
\item \nameref{man:Shield Bind} [Superior]
\end{itemize}
...
\vspace{-5pt}\begin{itemize}
  [itemsep=0.5mm]
\item \nameref{man:Power Draw}
\item \nameref{man:Shoot} [Superior]
\end{itemize}
\subsubsection{Tier 2 Maneuvers}
\nameref{man:Rapid Shot} [Superior] OR \nameref{man:Power Draw} [Superior]
...
\item [Effect:] Whenever you hit with a melee attack that rolls for Hit Location
  ...
  lands normally. Additionally, whenever you perform a \nameref{man:Joint
    Thrust} Maneuver, add +1 CP to that attack.   
\end{description}
...
\item [Description:] It’s a rare man who can survive in the Bad War. When two
  pike formations meet, and the world turns into an infinity of spear points,
  halberds, katzbalgers and screaming, dying men, they’ll be glad they brought
  you along.  
...
\begin{table}[ht]
  ...
  \begin{tabu} spread 0pt {*{2}{X[-1]}}
    Factor&Bonus\\\toprule
    Character is \nameref{bane:Virtuous} or \nameref{bane:Honorable} (or Both) &-1 RS\\
    Character is a \nameref{bane:Complete Monster}&+2 RS\\
    ...
    A Grandmaster with the \nameref{honor:Blood Ministration} ability is conducting the ceremony&-2 RS\\
  \end{tabu}
\end{table}
...
\begin{table}[ht]
  ...
  \begin{tabu} spread 0pt {X[r]@{~to~}X[l]X[2]}
    \multicolumn{2}{c}{d10 $\ +\ $}&\multirow{2}{*}{Mutation}\\
    \multicolumn{2}{c}{Blood Corruption}&\\\toprule
    1&6&\hyperref[sec:Mutation-Minor]{Minor}\\
    7&11&\hyperref[sec:Mutation-Moderate]{Moderate}\\
    12&14&\hyperref[sec:Mutation-Serious]{Serious}\\
    \multicolumn{2}{c}{15+}&\hyperref[sec:Mutation-Cataclysmic]{Cataclysmic}\\
  \end{tabu}
\end{table}
...
Regeneration Enhancements further halve \nameref{par:Pain} and \nameref{sec:Blood Loss} from Wounds, as well as 
...
---\quad \emph{Requires \nameref{honor:Regeneration} 1 and at least 6 Health}
...
\emph{Requires \nameref{honor:Regeneration} 2 and at least 6 Health}
...
---\quad \emph{Requires \nameref{honor:Regeneration} 2 and at least 6 Willpower}
...
---\quad \emph{Requires \nameref{honor:Sight} and \nameref{honor:Sense}, and at least 6 Willpower}
...
---\quad \emph{Requires \nameref{honor:Sight}, and at least 6 Wit and Agility}

Your Mobility increases by 50\% for the 
purposes of Movement, and you benefit from \nameref{par:Stains of Time} as per the Burdinadin racial ability, 
...
---\quad \emph{Requires \nameref{honor:Blood Potion} and at least 10 Health}
...
---\quad \emph{Requires \nameref{honor:Insight} and at least 10 Willpower}
...
---\quad \emph{Requires \nameref{honor:Hunger}, \nameref{honor:Disintegrate}, and at least 10 Health}
...
---\quad \emph{Requires \nameref{honor:Insight} and at least 10 Perception}

\subsection{Unkindly Weapons}
\subsubsection{Crow Hook}
An unusual weapon that is usually carried by Unkindlies as a symbol of their office, the Crow 
Hook is very much similar to a sickle in appearance, with a very pronounced reinforced point. 
The purpose of the Crow Hook was to aid the Unkindlies in climbing by digging into 
surfaces -- inaminate or living -- for a better grip. It is also capable of causing hideous wounds both 
with its cutting edges (unlike a harvesting sickle it is sharp on the outside as well as the inside) 
or with its triangular tip.

The Crow Hook is considered more of a tool than a weapon, however, 
and very few of the Unkindlies reach for it first when the fighting starts--though many wield one 
in the off-hand as a sort of unusual parrying dagger -- the strange hooked blade does make it 
useful for some flashy techniques. 

An amusing note: The Unkindlies don’t associate themselves with crows, and the name of the 
Crow Hook was only accepted begrudgingly after decades of informal lingo. The official title of 
the weapon is the “Stepping Hook,” and its origins can actually be traced to terrace farming in 
Kalmacia. 

(A pair of Crow Hooks grant a +4 bonus to \nameref{skill:Climbing} tests)
...
The concept behind the Dyne Maul was not tremendously complex--the execution of it in an 
easily reproducable, reliable, and most importantly safe (relatively speaking) package is what 
earned its inventor, the Burdinadin Unkindly “Black Dyne,” the honor of being immortalized in 
the weapon’s name. Good thing, too, he died in an unfortunate lab explosion a mere six months 
...
\begin{tabu} to \linewidth {*{11}{X[-1]}}
...
\subsubsection{Flip Halberd}
The Flip Halberd is a curious weapon designed to be carried while scaling a monster, and then 
unfolded to be swung two-handed at the creature’s weakpoints. 
\subsubsection{Harpoon Cannon}

\section{Dark Pyromancy} %NEEDS PRETTYING UP
\begin{quotation}
  Q: \emph{Restating one of my questions from earlier: How much PCP would Dark Pyromancy on its own cost? Star Vampires have it by default iirc, but what about Human or Din Dark Pyromancers? How much PCP do I need to pay to play one of those?}

  A\footnote{\href{http://boards.4chan.org/tg/thread/48772472\#p48880439} {A post by Jimmy}}:
  \emph{The current model is that Pyromancy will cost 15, whereas Dark Pyromancy will only cost 10, which in PCP terms is 4 and 2 points, respectively.}
\end{quotation}
Dark Pyromancy is the use of life force to perform magic. Unlike regular Pyromancy, Dark 
Pyromancers do not just use their own life force, but that of the world around them, sucking 
energy directly from nearby living things to power their dark magics. Dark Flame, as it is called, 
is sentient and malevolent, and despises all life and all living things. Dark Pyromancy will, 
unless kept closely in check, actively conspire against its user to kill him and to destroy all he 
holds dear. The exception to this, of course, is Vampires, who have no life force and thus are 
friends to the Dark Flame. 

\begin{quote}
  \textit{\emph{Development Note:} Dark Pyromancy primarily differs from Pyromancy in what you can 
    do with it and where the Fire comes from. Regular Pyromancers cannot Draw Fire, they 
    have a personal Fire stat that determines how much they can use each Round. This is a 
    disadvantage, but it also means that they don’t have to spend a Phase Drawing every 
    time they want to perform a spell, so it’s give-take.}
\end{quote}
...
However, Rituals are dangerous, because the “acolytes” or lesser pyromancers are essentially 
drawing in more Fire than they can normally handle. If one of the lesser Pyromancers draws 
more Fire in this way than their Lustre score, they must immediately make an Immolation Test, 
regardless of the fact that the Fire is immediately siphoned off to the head of the circle. 
Whatever happens to the individual Pyromancers participating in the ritual, the Fire they raise 
still flows to the one actually performing the ritual. 

Sacrifices are much simpler. Living things may be sacrificed to draw power for the Pyromancer 
to use for his own ends. This takes some time, with proper positioning of the sacrifices, some 
circles drawn in sterile materials to control the flow of the energies--generally one hour per 
creature to be sacrificed. Once the preparations are complete, the creatures need only be killed 
while the Pyromancer is standing in the center of the sacrificial area, and their energy will flow to 
him for his usage. A Pyromancer may also Draw Fire while the sacrifice is being performed, of 
course. 

The amount of Fire gained per creature sacrificed is determined by the size and complexity of 
the creature, and of course, sentient creatures are best. Additionally, there is a limit to how 
much fire can be gained by sacrificing creatures of a certain type. 
...
Once a Pyromancer has drawn Fire, they may maintain an amount up to their Lustre indefinitely, 
or may use it immediately. Any excess fire over Lustre must be used immediately, or else risk 
an Immolation.

Pyromancies have a base Fire cost, and then an X cost, the X being however much Fire the 
Pyromancer devotes to the Pyromancy. The cost is listed next to the name of the Pyromancy. 
Often the X Cost determines how great the effect or how many dice are rolled for the 
Pyromancy to determine its effect, and more is generally better. 

Once performed, the Fire is lost and more must be Drawn in order to perform more Pyromancies.\\
A Dark Pyromancer with stored Fire is very obvious, as they appear to radiate a purplish mist, like steam rising out of a cauldron.

\subsection{Dark Pyromancies}
\paragraph{Raise Undead}
---\quad [4+X]

The Dark Pyromancer causes corpses to rise up and become undead. The Pyromancer is not 
automatically in control of these Undead unless he uses Dominate Undead to force them to 
obey him. 

The number of undead that can be raised is determined by X, using the table below. Zombies 
count as 1, Skeletons count as 2, Unique Skeletons count as 3. 

Note that you need corpses to animate in order to raise the undead. These do not have to be new 
corpses, the buried cadavers in a graveyard will suffice just fine, but obviously you cannot 
animate bodies unless you have bodies. For mixed piles of bones, a skeleton can be assembled 
per 2-3 human corpses’ worth of bones, and a unique skeleton for 4 corpse’s worth. The bones 
do not have to be human. 

\begin{center}
  \begin{tabu} spread 0pt {X[-1] X[-1]}
    Fire Spent (X) &Undead Raised\\ \toprule
    1-10& X\\
    11-15& X*5\\
    16+& X*10\\
  \end{tabu}
...
\begin{table}[ht]
  ...
  \begin{tabu} spread 5pt {X[-1]X[-1]}
    Fire Spent (X) &Duration of Black Sun\\ \toprule
    1-10 &X Phases\\
    11-20 &X Minutes\\
    21-30 &X Hours\\
    31+ &X Days\\
...
The Pyromancer causes a whip of black fire to emerge from his body, lashing at the target. The 
lash remains for X Rounds, and can be used to make attacks on its own without using the 
wielder’s CP. 
The Lash attacks with X CP, it is LL Range, has a Strike TN of 6, and inflicts X + Pyromancer 
WIP+4 Damage that ignores armor. 

The damage inflicted by the Lash counts as Fire Damage,
but is really more like intense, instant cancer, with hair, teeth and vestigial eyes forming on the 
flesh warped by its hideous touch in the case of more extreme injuries. This effect can be 
reversed by Pyromancy healing, or by an Ascendant’s healing abilities, causing the mutations to 
slough off and burn away. 

\paragraph{Paralysis}
---\quad  [X]

With this spell, the Pyromancer can freeze a target in place, effectively petrifying them. 
This counts as a ranged attack with X at TN 7. If successful, the target must make a WIP test at 
RS equal to Bonus Successes or be frozen in place. The amount of time the character remains 
frozen is a number of minutes (each minute is ten Rounds) equal to the amount by which they 
failed the WIP test. If a character is in imminent danger, they may make another WIP test at RS 
...
\subsection{Melee Weapon Characteristics} %ADD HYPERLINKS FOR HAND-OFF
...
\begin{longtabu} to 1\linewidth {X[2,l]XX[-1,c]X[-1,c]XXX[-1,c]X[2,l]X[-3,c]X[-3,r]}
  ...
  Ballock Dagger					&Dagger			&1H	&H	&7(-1c)	&6(+1p)	&8(1)	&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}				&0	&5 cp\\
  Baselard						&Dagger			&1H	&S	&6(+0c)	&6(+0p)	&7(1)	&\nameref{wepqual:Fluid Thrusts}							&0	&2 sp\\
  Bowie Knife/Pishkan Toothpick	&Dagger			&1H	&S	&6(+0c)	&6(+1p)	&8(1)	&-										&0	&10 cp\\
  Cinquedea						&Dagger, Sword	&1H	&S	&6(+0c)	&7(+2p)	&8(0)	&-										&0	&3 sp\\
  Degan							&Dagger, Sword	&1H	&S	&6(-1c)	&6(+1p)	&7(0)	&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}				&0	&1 sp\\
  Dirk							&Dagger			&1H	&H	&7(-1c)	&6(+0p)	&7(0)	&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}				&0	&4 cp\\
  Khyber Knife					&Dagger, Sword	&1H	&S	&7(+0c)	&7(+1p)	&7(0)	&\nameref{wepqual:Draw} 2, \nameref{wepqual:Thin Blade}						&0	&10 cp\\
  Knife (Large)					&Dagger			&1H	&S	&6(-1c)	&6(+0p)	&9(0)	&\nameref{wepqual:Draw} 1, \nameref{wepqual:Light Blade}					&0	&7 cp\\
  Knife (Small)					&Dagger			&1H	&H	&6(-2c)	&6(-1p)	&9(0)	&\nameref{wepqual:Draw} 1, \nameref{wepqual:Light Blade}, \nameref{wepqual:Thin Blade}		&0	&6 cp\\
  Kukri							&Dagger			&1H	&S	&6(+1c)	&7(+0p)	&9(0)	&\nameref{wepqual:Draw} 2, \nameref{wepqual:Light Blade}, \nameref{wepqual:Forward Swept}		&0	&1 sp\\
  Main Gauche						&Dagger			&1H	&H	&7(-1c)	&7(+0p)	&6(3)	&\nameref{wepqual:Companion Weapon}, \nameref{wepqual:Light Blade}			&0	&3 sp\\
  Misericorde						&Dagger			&1H	&H	&9(-2c)	&5(-2p)	&10(0)	&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}, \nameref{wepqual:Thin Blade}	&0	&3 cp\\
  Navaja							&Dagger			&1H	&H	&6(+0c)	&7(-1p)	&8(0)	&\nameref{wepqual:Draw} 2, \nameref{wepqual:Light Blade}					&0	&6 cp\\
  Poignard						&Dagger			&1H	&H	&6(-1c)	&6(+0p)	&8(1)	&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}, \nameref{wepqual:Thin Blade}	&0	&6 cp\\
  Pugio							&Dagger			&1H	&H	&7(-1c)	&6(+1p)	&7(0)	&\nameref{wepqual:Light Blade}, \nameref{wepqual:Spatulate Tip} 2			&0	&6 cp\\
  Puukko							&Dagger			&1H	&H	&6(-1c)	&6(-0p)	&9(0)	&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}				&0	&4 cp\\
  Rondel Dagger					&Dagger			&1H	&S	&7(-1c)	&6(+1p)	&7(1)	&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}, \nameref{wepqual:Thin Blade}	&0	&6 cp\\
  Short Katzbalger				&Dagger, Sword	&1H	&S	&7(+0c)	&7(+0p)	&7(1)	&\nameref{wepqual:Spatulate Tip} 2						&0	&6 sp\\
  Stiletto						&Dagger			&1H	&H	&7(-1c)	&6(+0p)	&8(1)	&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}, \nameref{wepqual:Thin Blade}	&0	&8 cp\\
  Swordbreaker					&Dagger			&1H	&S	&6(-1c)	&6(+0p)	&7(1)	&\nameref{wepqual:Companion Weapon}, \nameref{wepqual:Parrying Teeth}		&0	&1 sp\\
  Tanto							&Dagger			&1H	&H	&7(+0c)	&6(+0p)	&8(1)	&\nameref{wepqual:Draw} 1, \nameref{wepqual:Light Blade}, \nameref{wepqual:Thin Blade}		&0	&3 sp\\
\end{longtabu}
...
\begin{longtabu} to 1\linewidth {X[2,l]XX[-1,c]X[-1,c]XXX[-1,c]X[2,l]X[-3,c]X[-3,r]}
  ...
  Arming Sword (Early)        &Sword          &1H      &M      &7(+1c) &7(+0p) &7(1)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Spatulate Tip} 2                 &0.5 &1 gp\\
  ...
  {Bastard Sword\  \label{wep:bastard-sword-1h}}\hyperref[wep:bastard-sword-2h]{$ \dagger $}              &Sword          &1H      &L      &7(+0c) &7(+1p) &8(2)           &\nameref{wepqual:Heavy Weapon}                            &1   &50 sp\\
  Cinquedea                   &Dagger, Sword  &1H      &S      &6(+0c) &7(+2p) &8(0)           &-                                       &0   &3 sp\\
  Claymore (Basket Hilted)	&Sword		&1H      &M      &7(+1c) &7(+0p) &7(4)           &\nameref{wepqual:Tight Grip} 2                           &0.5 &1 gp\\
  Cutlass						&Sword          &1H      &S      &7(+1c) &8(+0p) &7(3)           &-                                       &0.5 &1 sp\\
  Degan&Dagger, Sword  &1H      &S      &6(-1c) &6(+1p) &7(0)           &\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}              &0   &1 sp\\
  Dussack                     &Sword          &1H      &S      &7(+1c) &7(-1p) &7(3)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Tight Grip} 1                    &0.5 &1 sp\\
  Espada Ropera               &Sword          &1H      &L      &7(+0c) &7(+1p) &7(3)           &-                                       &0.5 &25 sp\\
  Falcata                     &Sword          &1H      &S      &6(+1c) &8(-1p) &8(3)           &\nameref{wepqual:Forward Swept}                           &0.5 &1 gp\\
  Falchion                    &Sword          &1H      &M      &7(+2c) &8(+0p) &8(2)           &-                                       &0.5 &18 cp\\
  Gladius                     &Sword          &1H      &S      &7(+1c) &7(+1p) &7(0)           &-                                       &0   &1 sp\\
  Karthacki Dueling Sword     &Sword          &1H      &M      &6(-1b) &6(+0p) &7(0)           &\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}, \nameref{wepqual:Thin Blade}  &0.5 &10 sp\\
  {Katana \hyperref[wep:katana-2h]{$ \dagger $}\label{wep:katana-1h}}                     &Sword          &1H      &M      &7(+1c) &8(+1p) &8(1)           &\nameref{wepqual:Draw} 3, \nameref{wepqual:Heavy Weapon}                    &1   &50 sp\\
  Katzbalger                  &Sword          &1H      &S      &7(+1c) &8(+0p) &7(2)           &\nameref{wepqual:Spatulate Tip} 2                         &0.5 &4 sp\\
  Katzbalger (Short)          &Dagger, Sword  &1H      &S      &7(+0c) &7(+0p) &7(1)           &\nameref{wepqual:Spatulate Tip} 2                         &0   &6 sp\\
  Khyber Knife                &Dagger, Sword  &1H      &S      &7(+0c) &7(+1p) &7(0)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Thin Blade}                      &0   &10 cp\\
  Kilij                       &Sword          &1H      &M      &7(+1c) &8(+0p) &7(2)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Cavalry Sword}                   &0.5 &30 sp\\
  Koncerz                     &Sword          &1H      &VL     &7(-2c) &8(+2p) &8(3)           &\nameref{wepqual:AP Thrust} 2, \nameref{wepqual:Couched Charge}             &0.5 &25 sp\\
  Khopesh                     &Sword, Blunt   &1H      &S      &6(+1c) &9(-1p) &8(0)           &\nameref{wepqual:Forward Swept}, \nameref{wepqual:Hook}                     &0.5 &1 sp\\
  {Kriegsmesser \hyperref[wep:kriegsmesser-2h]{$ \dagger $}\label{wep:kriegsmesser-1h}}               &Sword          &1H      &M      &7(+1c) &8(+0p) &8(2)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Heavy Weapon}                    &1   &10 sp\\
  Langes Messer               &Sword          &1H      &M      &7(+1c) &7(+0p) &8(2)           &\nameref{wepqual:Draw} 2                                  &0.5 &1 sp\\
  {Longsword \hyperref[wep:longsword-2h]{$ \dagger $}\label{wep:longsword-1h}}                  &Sword          &1H      &L      &7(+1c) &7(+0p) &8(2)           &\nameref{wepqual:Heavy Weapon}                            &1   &50 sp\\
  Pallasch                    &Sword          &1H      &L      &7(+1c) &8(+1p) &7(3)           &\nameref{wepqual:Cavalry Sword}                           &0.5 &35 sp\\
  Rapier                      &Sword          &1H      &L      &6(-1c) &6(+0p) &7(3)           &\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Thin Blade}               &0.5 &30 sp\\
  Saber (Early)               &Sword          &1H      &M      &7(+0c) &7(+0p) &8(1)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Cavalry Sword}                   &0.5 &10 sp\\
  Saber (Hussar)              &Sword          &1H      &M      &7(+1c) &7(-1p) &7(3)           &\nameref{wepqual:Draw} 3, \nameref{wepqual:Cavalry Sword}                   &0.5 &25 sp\\
  Saber (Karabela)            &Sword          &1H      &M      &7(+0c) &8(-1p) &7(3)           &\nameref{wepqual:Draw} 4, \nameref{wepqual:Cavalry Sword}                   &0.5 &30 sp\\
  Saber (Zellish)             &Sword          &1H      &M      &7(+1c) &8(+0p) &8(3)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Forward Swept}                   &0.5 &15 sp\\
  Schiavona                   &Sword          &1H      &L      &7(+0c) &7(+0p) &7(3)           &\nameref{wepqual:Tight Grip} 2                            &0.5 &1 gp\\
  Scimitar                    &Sword          &1H      &M      &7(+0c) &7(-1p) &7(2)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Cavalry Sword}                   &0.5 &15 sp\\
  Scythe-Sword                &Sword          &1H      &S      &7(+1c) &9(-1p) &8(1)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Forward Swept}                   &0.5 &16 cp\\
  Shaska                      &Sword          &1H      &M      &7(+0c) &7(+0p) &7(0)           &\nameref{wepqual:Draw} 2, \nameref{wepqual:Cavalry Sword}                   &0.5 &15 sp\\
  Short Sword                 &Sword          &1H      &S      &7(+0c) &6(+1p) &7(1)           &-                                       &0   &1 sp\\
  Sidesword                   &Sword          &1H      &L      &7(+1c) &7(+1p) &7(3)           &-                                       &0.5 &15 sp\\
  Smallsword                  &Sword          &1H      &M      &6(-2c) &6(+0p) &7(3)           &\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}, \nameref{wepqual:Thin Blade}  &0.5 &30 sp\\
  Spadroon                    &Sword          &1H      &M      &6(-1c) &6(+0p) &7(3)           &\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Light Blade}              &0.5 &30 sp\\
  Tesshake                    &Sword          &1H      &S      &7(+1c) &7(+0p) &8(3)           &-                                       &0.5 &1 sp\\
  Tulwar                      &Sword          &1H      &S      &7(+0c) &7(-2p) &8(2)           &\nameref{wepqual:Draw} 4, \nameref{wepqual:Tight Grip} 2, \nameref{wepqual:Cavalry Sword}     &0.5 &25 sp\\
  Urumi                       &Sword          &1H      &VL     &7(+0c) &NA     &9(1)           &\nameref{wepqual:Chain} 3, \nameref{wepqual:Draw} 2                         &0   &30 sp\\
  Wakizashi                   &Sword          &1H      &S      &7(+0c) &8(+0p) &7(1)           &\nameref{wepqual:Draw} 1                                  &0   &10 sp\\
  War Cleaver                 &Sword          &1H      &M      &7(+2c) &8(-1p) &8(0)           &\nameref{wepqual:Heavy Weapon}                            &0.5 &6 cp\\
  Yataghan                    &Sword          &1H      &S      &7(+1c) &8(+0p) &7(0)           &\nameref{wepqual:Forward Swept}, \nameref{wepqual:Draw} 1                   &0.5 &10 sp\\
\end{longtabu}
...
\begin{longtabu} to 1\linewidth {X[2,l]XX[-1,c]X[-1,c]XXX[-1,c]X[2,l]X[-3,c]X[-3,r]}
  ...
  Weapon Name						&Weapon Type	&Hands&Reach&Swing&Thrust&Defense (Guard)&Special						&Weight	&Cost\\\toprule\endfirsthead
  Weapon Name					&Weapon Type	&Hands	&Reach	&Swing	&Thrust	&Defense (Guard)	&Special						&Wt		&Cost\\\toprule\endhead
  {Bastard Sword\ \hyperref[wep:bastard-sword-1h]{$ \ddagger $}\label{wep:bastard-sword-2h}}				&Sword			&2H		&L		&7(+1c)	&7(+2p)	&7(2)				&\nameref{wepqual:Hand-Off}, \nameref{wepqual:Heavy Weapon} 			&1		&50 sp\\
  Claymore					&Sword			&2H		&L		&7(+2c)	&7(+0p)	&7(2)	&\nameref{wepqual:Heavy Weapon} &2 &50 sp\\
  Estoc						&Sword 			&2H		&L		&8(+0b)	&6(+2p)	&7(2)	&\nameref{wepqual:AP Thrust} 1, \nameref{wepqual:Thin Blade}, \nameref{wepqual:Fluid Thrusts}			&1		&45 sp\\
  Flammenschwert				&Sword			&2H		&VL		&7(+2c)	&8(+3p)	&7(3)	&\nameref{wepqual:Draw} 1, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Heavy Weapon}				&2		&4 gp\\
  Godenak &Sword &2H &M &7(+3c) &8(-1p) &8(0) &\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Heavy Weapon} &1 &2 sp\\
  Grosses Messer &Sword &2H &L &7(+2c) &8(+0p) &8(1) &\nameref{wepqual:Draw} 3, \nameref{wepqual:Heavy Weapon} &2 &1 gp\\
  Katana 					&Sword &2H &M 	&7(+2c) &7(+1p) &7(1) &\nameref{wepqual:Draw} 4, \nameref{wepqual:Hand-Off}, \nameref{wepqual:Heavy Weapon} 			&1 	&50 sp\\
  Katzbalger (Large) 		&Sword &2H &L 	&7(+2c) &8(+0p) &7(2) &\nameref{wepqual:Spatulate Tip} 2, \nameref{wepqual:Heavy Weapon} 				&1 	&2 gp \\
  Kriegsmesser 			&Sword &2H &M 	&7(+2c) &7(+0p) &7(2) &\nameref{wepqual:Draw} 3, \nameref{wepqual:Hand-Off}, \nameref{wepqual:Heavy Weapon} 			&1 	&10 sp\\
  Longsword 				&Sword &2H &L 	&7(+2c) &7(+1p) &7(2) &\nameref{wepqual:Hand-Off}, \nameref{wepqual:Heavy Weapon} 					&1 	&50 sp\\
  Massive Godenak 		&Sword &2H &VL	&7(+4c) &8(+0p) &8(0) &\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Freakishly Large}	&	&\\    
  Montante 				&Sword &2H &VL &7(+2c) &7(+1p) &7(2) &\nameref{wepqual:Heavy Weapon} 								&2 	&4 gp\\
  No-Dachi 				&Sword &2H &L 	&7(+2c) &8(+0p) &8(1) &\nameref{wepqual:Draw} 3, \nameref{wepqual:Heavy Weapon} 						&1 	&3 gp\\
  Swiss Saber (Schnepf) 	&Sword &2H &L 	&7(+1c) &7(+0p) &7(3) &\nameref{wepqual:Draw} 3, \nameref{wepqual:Heavy Weapon} 						&1 	&45 sp\\
  Zweihander 				&Sword &2H &VL &7(+3c) &8(+2p) &7(2) &\nameref{wepqual:Heavy Weapon} 								&2 	&75 sp\\
  Zweihander (Grutte) 	&Sword &2H &EL &7(+4c) &8(+3p) &7(2) &\nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Freakishly Large} 			&3 	&6 gp\\
\end{longtabu}
...
\begin{longtabu} to 1\linewidth {X[2,l]XX[-1,c]X[-1,c]XXX[-1,c]X[2,l]X[-3,c]X[-3,r]}
  ...
  Weapon Name						&Weapon Type	&Hands&Reach&Swing&Thrust&Defense (Guard)&Special						&Weight	&Cost\\\toprule\endfirsthead
  Weapon Name						&Weapon Type	&Hands&Reach&Swing&Thrust&Defense (Guard)&Special						&Weight	&Cost\\\toprule\endhead
  {Battleaxe \hyperref[wep:battleaxe-2h]{$ \dagger $}\label{wep:battleaxe-1h}} &Blunt &1H &M &7(+2c) &7(-2b) &9(0)& \nameref{wepqual:AP Swing} 1, \nameref{wepqual:Hand-Off}, \nameref{wepqual:Hook}, Thrusting Slot, \nameref{wepqual:Shock} 2, Swinging Slot &1 &6 sp\\
  Bar Mace &Blunt &1H &S &7(+1b) &7(-2b) &7(0)& \nameref{wepqual:AP Swing} 1, \nameref{wepqual:Shock} 1, Thrusting Slot &0 &1 sp\\
  ...
  Double-Headed Flail &Blunt &1H &M &8(+1b) &8(-2b) &10(0)& \nameref{wepqual:Chain} 1, \nameref{wepqual:Multi-Hit} Swing 2, \nameref{wepqual:Shock} 2 &1 &9 cp\\
  Hand Axe/ Hatchet &Blunt &1H &S &7(+2c) &7(-2b) &8(0)& \nameref{wepqual:AP Swing} 1, \nameref{wepqual:Hook}, \nameref{wepqual:Shock} 1, Swing Slot, Thrusting Slot &0 &6 cp\\
  Khopesh Sword, &Blunt &1H &S &6(+1c) &9(-1p) &8(0)& \nameref{wepqual:Forward Swept}, \nameref{wepqual:Hook} &0.5 &1 sp\\
  Light Flail &Blunt &1H &M &7(+2b) &8(-2b) &9(0)& \nameref{wepqual:Chain} 2, \nameref{wepqual:Shock} 2 &1 &6 sp\\
  Light Mace (Flanged) &Blunt &1H &S &7(+2b) &7(-2b) &7(0)& \nameref{wepqual:AP Swing} 2, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Shock} 2, Thrusting Slot &0 &3 sp\\
  Light Mace (Knobbed) &Blunt &1H &S &7(+2b) &7(-2b) &7(0)& \nameref{wepqual:AP Swing} 1, \nameref{wepqual:Shock} 2, Thrusting Slot &0 &4 cp\\
  Light Mace (Spiked) &Blunt &1H &S &7(+2b) &7(-2b) &7(0)& \nameref{wepqual:Bleed} 2, \nameref{wepqual:Shock} 2, Thrusting Slot &0 &8 cp\\
  {Tabarzin \hyperref[wep:tabarzin-2h]{$ \dagger $}\label{wep:tabarzin-1h}} &Blunt &1H &L &7(+2c) &8(+0p) &9(0)& \nameref{wepqual:AP Swing} 1, \nameref{wepqual:Hand-Off}, \nameref{wepqual:Hook}, \nameref{wepqual:Shock} 1, Swinging Slot, Thrusting Slot &2 &10 sp\\
  Warhammer (Standard) &Blunt &1H &S &7(+2b) &7(-2b) &8(0)& \nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 1, Reverse Slot, \nameref{wepqual:Shock} 1, Thrusting Slot &0 &6 cp\\
  War Pick &Blunt &1H &S &7(+2p) &7(-2b) &8(0)& \nameref{wepqual:AP Swing} 2, \nameref{wepqual:Hook}, Reverse Slot, Thrusting Slot, \nameref{wepqual:Thin Blade} &0 &2 sp\\
  \\
  \\
  ...
  Reverse Hammer	&Blunt	&1H	&-	&7(+0b)&-	&-		&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Shock} 1, Weapon Attachment (Swing) &0 &6 cp\\
  Reverse Spike	&Blunt	&1H	&-	&7(+0p)&-	&-		&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Hook}, Weapon Attachment (Swing) &0 &6 cp\\
  Weighted Chain	&Blunt	&1H	&VL	&8(+1b)&-	&8(0)	&\nameref{wepqual:Chain} 3, \nameref{wepqual:Hook},\nameref{wepqual:Shock} 2, Weapon Attachment (Swing) &1 &6 cp\\
\end{longtabu}
...
%   Reverse Hammer	&Blunt	&1H	&-	&7(+0b)&-	&-		&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Shock} 1, Weapon Attachment (Swing) &0 &6 cp\\
%   Reverse Spike	&Blunt	&1H	&-	&7(+0p)&-	&-		&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Hook}, Weapon Attachment (Swing) &0 &6 cp\\
%   Weighted \nameref{wepqual:Chain}	&Blunt	&1H	&VL	&8(+1b)&-	&8(0)	&\nameref{wepqual:Chain} 3, \nameref{wepqual:Hook},\nameref{wepqual:Shock} 2, Weapon Attachment (Swing) &1 &6 cp\\
% \end{tabu}
% END_FOLD
...
\begin{longtabu} to 1\linewidth {X[2,l]XX[-1,c]X[-1,c]XXX[-1,c]X[2,l]X[-3,c]X[-3,r]}
  ...
  Weapon Name						&Weapon Type	&Hands&Reach&Swing&Thrust&Defense (Guard)&Special						&Weight	&Cost\\\toprule\endfirsthead
  Weapon Name				&Weapon Type	&Hands	&Reach	&Swing&Thrust&Defense (Guard)&Special																	&Weight	&Cost\\\toprule\endhead
  Battleaxe				&Blunt			&2H		&M		&7(+3c)&7(-2b)&8(0)&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Hand-Off}, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, Thrusting Slot, \nameref{wepqual:Shock} 2, Swinging Slot	&1 &6 sp\\
  Club (Large) 			&Blunt			&2H		&M		&6(+1b)&7(-1b)&7(0)&\nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 1, Swinging Slot, Thrusting Slot								&1 &3 cp\\
  Dane Axe 				&Blunt			&2H		&L		&7(+4c)&8(+0p)&8(0)&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Crushing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, \nameref{wepqual:Shock} 2, Swinging Slot, Thrusting Slot	&2 &7 sp\\
  Goedendag 				&Blunt, Polearm	&2H		&L		&7(+3b)&8(+2p)&8(0)&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:AP Thrust} 2, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 2							&2 &1 sp\\
  Gunstock Club 			&Blunt			&2H		&M		&7(+2b)&7(-1b)&7(0)&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 1, Swinging Slot									&1 &7 cp\\
  Heavy Mace (Flanged)	&Blunt			&2H		&M		&7(+3b)&7(-2b)&7(0)&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Crushing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 1										&1 &6 sp\\
  Heavy Mace (Knobbed)	&Blunt			&2H		&M		&7(+3b)&7(-2b)&7(0)&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 4													&1 &1 sp\\
  Heavy Mace (Spiked) 	&Blunt			&2H		&M		&7(+3b)&7(-2b)&7(0)&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Bleed} 3, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Heavy Weapon}										&1 &2 sp\\
  Morningstar 			&Polearm, Blunt	&2H		&L		&7(+3b)&8(+1p)&8(0)&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Bleed} 3, \nameref{wepqual:Heavy Weapon}													&5 &1 sp\\
  Poleaxe 				&Polearm, Spear, Blunt &2H&L	&7(+2c)&7(+2p)&7(0)&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:AP Thrust} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 2, Swinging Slot,\nameref{wepqual:Thin Blade}			&5	&8 sp\\
  Pole-Flail				&Blunt, Polearm	&2H		&L		&7(+2b)&7(-2b)&8(0)&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Chain} 2, \nameref{wepqual:Crushing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 2								&2 &2 sp\\
  Tabarzin				&Blunt			&2H		&L		&7(+3c)&8(+0p)&8(0)&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Hand-Off}, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, \nameref{wepqual:Shock} 2, Swinging Slot, Thrusting Slot 	&2 &10 sp\\
  Warhammer (Heavy)		&Blunt			&2H		&M		&7(+2b)&7(-2b)&8(0)&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 2, Swinging Slot, Thrusting Slot		&1	&1 sp\\
  War Maul				&Blunt			&2H		&M		&7(+3b)&8(-2b)&8(0)&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 4 &2 &2 sp\\
  Wood Axe				&Blunt			&2H		&M		&7(+2c)&8(-2b)&8(0)&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, \nameref{wepqual:Shock} 2 &1 &2 sp\\
  \\
  \\
  \multicolumn{10}{c}{2H Blunt Weapon Attachments}\\\tabucline{1-10}
  Arming Spike &Blunt &2H &- &-(+0p) &- &- &Weapon Attachment (Thrust) &0 &1 cp\\
  Reverse Blade &Blunt &2H &- &7(+3c) &- &- &\nameref{wepqual:Heavy Weapon}, Weapon Attachment (Swing) &0 &6 cp\\
  Reverse Hammer &Blunt &2H &- &7(+2b) &- &- &\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 1, Weapon Attachment (Swing) &0 &6 cp\\
  Reverse Spike &Blunt &2H &- &7(+2p) &- &- &\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, Weapon Attachment (Swing) &0 &6 cp\\
\end{longtabu}
...
\begin{longtabu} to 1\linewidth {X[2,l] X X[-1,c] X[-1,c] XX X[-1,c] X[2,l] X[-3,c] X[-3,r]}
  ...
  Weapon Name						&Weapon Type			&Hands	&Reach	&Swing		&Thrust	&Defense (Guard)	&Special																	&Weight	&Cost\\\toprule\endfirsthead
  Weapon Name						&Weapon Type			&Hands	&Reach	&Swing		&Thrust	&Defense (Guard)	&Special																	&Weight	&Cost\\\toprule\endhead
  Ahlspiess 						&Polearm, Spear			&2H		&L		&8(-1b)		&7(+1p) &7(0)				&\nameref{wepqual:AP Thrust} 3,\nameref{wepqual:Thin Blade} 													&5		&4 sp\\
  Fauchard 						&Polearm, Spear			&2H		&VL 	&7(+2c)		&8(+1p) &7(0)				&\nameref{wepqual:Forward Swept}, \nameref{wepqual:Heavy Weapon}, Swinging Slot,								&4		&1 sp\\
  Ge (Chinese Dagger-Axe Halberd)	&Polearm, Spear			&2H		&VL 	&7(+3p)		&7(+2p) &7(0)				&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}											&5		&1 sp\\
  Half-Pike {$ \dagger $}						&Spear					&1H		&L		&8(-2c)		&7(+1p) &8(0)				&\nameref{wepqual:Fluid Thrusts}																&-		&-\\
  Half-Pike {$ \ddagger $} 						&Spear 					&2H		&L		&7(-1c)		&6(+2p) &7(0)				&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Hand-Off} 													&4		&1 sp\\
  Lance (Light) 					&Spear 					&1H		&VL		&10(-1c)	&8(+2p) &10(0)				&\nameref{wepqual:Couched Charge}, \nameref{wepqual:Heavy Weapon} 												&4		&1 cp\\
  Lance (Heavy) 					&Spear 					&1H		&EL		&10(-1c)	&9(+3p) &10(0)				&\nameref{wepqual:Couched Charge}, \nameref{wepqual:Heavy Weapon} 												&6		&1 sp\\
  Lance (Hollow) 					&Spear 					&1H		&LL		&10(-1c)	&9(+3p) &10(0)				&\nameref{wepqual:Couched Charge}, \nameref{wepqual:Heavy Weapon} 												&8		&4 sp\\
  Longstaff 						&Polearm, Spear			&2H		&EL		&7(+0b)		&7(-1b) &7(0)				&\nameref{wepqual:Heavy Weapon}																&6		&4 cp\\
  Military Fork 					&Polearm, Spear			&2H		&VL		&10(-1c)	&7(+1p) &7(0)				&\nameref{wepqual:Multi-Hit} Thrust 2, Swinging Slot, 										&5		&3 cp\\
  Musket (Butt) 					&Spear					&2H		&H		&7(+1b)		&7(-1b) &8(0)				&\nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 2														&0		&-\\
  Musket (Bayonet) 				&Spear					&2H		&L		&9(-1c)		&7(+2p) &8(0)				&\nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Thin Blade}													&0		&3 cp\\
  Partisan 						&Polearm, Spear			&2H		&EL		&8(+2c)		&7(+3p) &7(0)				&\nameref{wepqual:Fluid Thrusts},																&5		&10 sp\\
  Pike 							&Spear 					&2H		&LL		&10(-2c)	&8(+3p) &9(0)				&Brace																		&6		&1 sp\\
  Poleaxe 						&Polearm, Spear, Blunt	&2H		&L		&7(+2c)		&7(+2p) &7(0)				&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:AP Thrust} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 2, Swinging Slot, \nameref{wepqual:Thin Blade}	&5		&8 sp\\
  Quarterstaff 					&Polearm, Spear			&2H		&VL		&6(+0b)		&6(-1b) &6(0)				&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Heavy Weapon}												&4		&3 cp\\
  Ranseur 						&Polearm, Spear			&2H		&EL		&8(+0c)		&7(+2p) &7(0)				&																			&5		&1 sp\\
  Spear (Arming) {$ \dagger $} 				&Spear					&1H		&VL		&9(-1c)		&7(+1p) &9(0)				&																			&4		&6 cp\\
  Spear (Arming){$ \ddagger $} 					&Spear					&2H		&VL		&7(+0c)		&7(+2p) &7(0)				&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Hand-Off},													&4		&6 cp\\
  Spear (Short) 					&Spear					&1H		&M		&8(+0c)		&7(+2p) &8(0)				&\nameref{wepqual:Fluid Thrusts} 																&0		&3 cp\\
  Spear (Standard) {$ \dagger $}				&Spear					&1H		&EL		&9(+0c)		&7(+2p) &9(0)				&																			&4		&8 cp\\
  Spear (Standard){$ \ddagger $} 				&Spear					&2H		&EL		&8(+0c)		&7(+3p) &8(0)				&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Hand-Off}, 													&4		&8 cp\\
  Spetum 							&Polearm, Spear			&2H		&VL		&8(+1c)		&7(+2p) &7(0)				&\nameref{wepqual:Fluid Thrusts}, 															&4		&2 sp\\
  Swordstaff 						&Polearm, Spear			&2H		&EL		&8(+3c)		&7(+3p) &8(0)				&																			&8		&3 sp\\
  Trident {$ \dagger $}						&Polearm, Spear			&1H		&L		&10(-1c)	&8(-1p) &9(0)				&\nameref{wepqual:Multi-Hit} Thrust 3, 														&4		&5 cp\\
  Trident {$ \ddagger $}						&Polearm, Spear			&2H		&L		&9(+0c)		&7(+0p) &7(0)				&\nameref{wepqual:Hand-Off}, \nameref{wepqual:Multi-Hit} Thrust 3, 												&4		&5 cp\\
  Yari (Jumonji) 					&Polearm, Spear			&2H		&VL		&7(+2c)		&7(+2p) &7(0)				&\nameref{wepqual:Heavy Weapon}, 																&4		&2 sp\\
  Yari (Bishamon) 				&Polearm, Spear			&2H		&VL		&7(+3c)		&7(+2p) &7(0)				&\nameref{wepqual:AP Swing} 1, 																&4		&3 sp\\
  Yari (Kata Kama) 				&Polearm, Spear			&2H		&VL		&7(+2p/+2c)	&7(+2p) &7(0)				&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, 											&4		&3 sp\\
  \\
  \\
  \multicolumn{10}{c}{Spear Weapon Attachments}\\\tabucline{1-10}
  Reverse Blade &Spear&* &- &7(+2c) &- &- &\nameref{wepqual:Heavy Weapon}, Weapon Attachment (Swing) &0 &6 cp\\
  Reverse Hammer &Spear&* &- &7(+1b) &- &- &\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 1, Weapon Attachment (Swing) &0 &6 cp\\
  Reverse Spike &Spear&* &- &7(+1p) &- &- &\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, Weapon Attachment (Swing) &0 &6 cp\\
  Weapon Queue &Spear&* &- &7(-2c) &7(+0p) &8(0) &\nameref{wepqual:AP Swing} 1,\nameref{wepqual:Thin Blade}, Weapon Attachment (Thrust) &0 &4 cp\\
...
\begin{longtabu} to 1\linewidth {X[2,l]XX[-1,c]X[-1,c]XXX[-1,c]X[2,l]X[-3,c]X[-3,r]}
  ...
  Weapon Name						&Weapon Type			&Hands	&Reach	&Swing		&Thrust		&Defense (Guard)	&Special																	&Weight	&Cost\\\toprule\endhead
  Ahlspiess						&Polearm, Spear 		&2H		&L		&8(-1b)		&7(+1p)		&7(0)				&\nameref{wepqual:AP Thrust} 3,\nameref{wepqual:Thin Blade}														&5		&4 sp\\
  Bardiche						&Polearm				&2H		&VL		&7(+4c)		&9(-1p)		&8(0)				&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Crushing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 2, Swinging Slot				&5		&2 sp\\
  Bec de Corbin					&Polearm				&2H		&VL		&7(+2p)		&7(+2p)		&7(0)				&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, Swinging Slot, \nameref{wepqual:Thin Blade}					&5		&1 sp\\
  Bill (Black)					&Polearm				&2H		&VL		&8(+3c)		&7(+2p)		&7(0)				&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, \nameref{wepqual:Shock} 2, Swinging Slot,		&5		&1 sp\\
  Bill (Forest)					&Polearm				&2H		&EL		&8(+2c)		&7(+2p)		&8(0)				&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, \nameref{wepqual:Shock} 2, Swinging Slot,		&5		&1 sp\\
  Falx							&Polearm				&2H		&L		&8(+3c)		&10(-1p)	&8(0)				&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Forward Swept}, \nameref{wepqual:Heavy Weapon}									&4		&1 sp\\
  Fauchard 						&Polearm, Spear			&2H		&VL		&7(+2c)		&8(+1p) 	&7(0)				&\nameref{wepqual:Forward Swept}, \nameref{wepqual:Heavy Weapon}, Swinging Slot,								&4		&1 sp\\
  Ge (Chinese Dagger-Axe Halberd)	&Polearm, Spear			&2H		&VL		&7(+3p)		&7(+2p) 	&7(0)				&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook},											&5		&1 sp\\
  Glaive 							&Polearm				&2H		&VL		&7(+2c)		&8(+1p) 	&7(0)				&\nameref{wepqual:Draw} 2, \nameref{wepqual:Heavy Weapon}, Swinging Slot,										&5		&3 sp\\
  Guandao (Chinese Glaive)		&Polearm				&2H		&VL		&7(+2c)		&8(+2p) 	&7(0)				&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Draw} 2, \nameref{wepqual:Heavy Weapon},											&5		&5 sp\\
  Halberd							&Polearm				&2H		&VL		&7(+3c)		&8(+2p) 	&7(0)				&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Crushing} 2, \nameref{wepqual:Heavy Weapon}, Swinging Slot,						&5		&3 sp\\
  Lochaber Axe					&Polearm				&2H		&VL		&7(+2c)		&8(+1p) 	&8(0)				&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, \nameref{wepqual:Shock} 2									&5		&2 sp\\
  Longstaff						&Polearm, Spear			&2H		&EL		&7(+0b)		&7(-1b) 	&7(0)				&\nameref{wepqual:Heavy Weapon}																&6		&4 cp\\
  Lucerne Hammer					&Polearm				&2H		&L		&7(+2b)		&7(+2p) 	&7(0)				&\nameref{wepqual:Crushing} 2, \nameref{wepqual:Shock} 2, \nameref{wepqual:AP Thrust} 1, \nameref{wepqual:Heavy Weapon}, Swinging Slot, \nameref{wepqual:Thin Blade}	&5		&8 sp\\
  Military Fork					&Polearm, Spear			&2H		&VL		&10(-1c)	&7(+1p) 	&7(0)				&\nameref{wepqual:Multi-Hit} Thrust 2, Swinging Slot,											&5		&3 cp\\
  Morningstar						&Polearm, Blunt			&2H		&L		&7(+3b)		&8(+1p) 	&8(0)				&\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Bleed} 3, \nameref{wepqual:Heavy Weapon}											&5		&1 sp\\
  Naginata						&Polearm, Spear			&2H		&VL 	&7(+2c)		&7(+1p) 	&7(0)				&\nameref{wepqual:Draw} 2, \nameref{wepqual:Fluid Thrusts}														&4		&10 sp\\
  Partisan						&Polearm, Spear			&2H		&EL 	&8(+2c)		&7(+3p) 	&7(0)				&\nameref{wepqual:Fluid Thrusts},																&5		&10 sp\\
  Pike							&Spear					&2H		&LL		&10(-2c)	&8(+3p) 	&9(0)				&\nameref{wepqual:Brace}																		&6		&1 sp\\
  Poleaxe							&Polearm, Spear, Blunt	&2H		&L		&7(+2c)		&7(+2p) 	&7(0)				&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:AP Thrust} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 2, Swinging Slot, \nameref{wepqual:Thin Blade}	&5		&8 sp\\
  Quarterstaff					&Polearm, Spear			&2H		&VL		&6(+0b)		&6(-1b) 	&6(0)				&\nameref{wepqual:Fluid Thrusts}, \nameref{wepqual:Heavy Weapon}												&4		&3 cp\\
  Saber-Halberd					&Polearm				&2H		&VL		&7(+3c)		&8(+0p) 	&7(0)				&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Draw} 2, \nameref{wepqual:Heavy Weapon}, Swinging Slot				&5		&15 sp\\
  Spetum							&Polearm, Spear			&2H		&VL		&8(+1c)		&7(+2p) 	&7(0)				&\nameref{wepqual:Fluid Thrusts}																&4		&2 sp\\
  Swordstaff						&Polearm, Spear			&2H		&EL		&8(+3c)		&7(+3p) 	&8(0)				&																			&8		&3 sp\\
  Trident{$ \dagger $}						&Polearm, Spear			&1H		&L		&10(-1c)	&8(-1p) 	&9(0)				&\nameref{wepqual:Multi-Hit} Thrust 3															&		&\\
  Trident{$ \ddagger $}							&Polearm, Spear			&2H		&L		&9(+0c)		&7(+0p) 	&7(0)				&\nameref{wepqual:Hand-Off}, \nameref{wepqual:Multi-Hit} Thrust 3												&4		&5 cp\\
  War-Scythe						&Polearm				&2H		&VL		&7(+3c)		&9(+0p) 	&8(0)				&\nameref{wepqual:Forward Swept}, \nameref{wepqual:Heavy Weapon},												&4		&4 cp\\
  Yari (Jumonji)					&Polearm, Spear			&2H		&VL		&7(+2c)		&7(+2p) 	&7(0)				&\nameref{wepqual:Heavy Weapon},																&4		&2 sp\\
  Yari (Bishamon) 				&Polearm, Spear			&2H		&VL		&7(+3c)		&7(+2p) 	&7(0)				&\nameref{wepqual:AP Swing} 1,																&4		&3 sp\\
  Yari (Kata Kama)				&Polearm, Spear			&2H		&VL		&7(+2p/+2c)	&7(+2p) 	&7(0)				&\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Heavy Weapon}, Hook,											&4		&3 sp\\
  \\\\
  \multicolumn{10}{c}{Polearm Weapon Attachments}\\\tabucline{1-10}
  Reverse Blade &Polearm &- &- &7(+2c) &- &- &\nameref{wepqual:Heavy Weapon}, Weapon Attachment (Swing) &0 &6 cp\\
  Reverse Hammer &Polearm &- &- &7(+1b) &- &- &\nameref{wepqual:AP Swing} 1, \nameref{wepqual:Crushing} 1, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Shock} 1, Weapon Attachment (Swing) &0 &6 cp\\
  Reverse Spike &Polearm &- &- &7(+1p) &- &- &\nameref{wepqual:AP Swing} 2, \nameref{wepqual:Heavy Weapon}, \nameref{wepqual:Hook}, Weapon Attachment (Swing) &0 &6 cp\\
  Weapon Queue &Polearm &- &- &7(-2c) &7(+0p) &8(0) &\nameref{wepqual:AP Swing} 1,\nameref{wepqual:Thin Blade}, Weapon Attachment (Thrust) &0 &4 cp
\end{longtabu}
...
When making a Swinging attack against a Hit Location with \nameref{par:Hard} armor protection, this weapon Inflicts X additional damage against any Armor, up to the AV of the Armor.

\vspace{-5pt}\paragraph[AP Thrust]{\label{wepqual:AP Thrust}AP Thrust [X]}---\quad Armor Piercing Thrust [X].

When making a Thrusting attack against a Hit Location with \nameref{par:Hard} armor protection, this weapon Inflicts X additional damage against any Armor, up to the AV of the Armor.
...
Any attack made at Swing TN with this weapon ignores the first X successes of an enemy’s Parry or Block defense, including Parrying and Blocking Maneuvers like \nameref{man:Riposte} or \nameref{man:Arm Parry}. Additionally, this weapon can neither engage in, nor be engaged in a \nameref{man:Hilt Push} of any sort.
...
When making a \nameref{man:Lance Charge} attack with this weapon, reduce its
Thrusting TN by 2, and use the Horse’s STR as the base for damage instead of
your own.. However, your Reach is not increased by the \nameref{boon:Tall} Boon.
...
When making a \hyperref[man:grappling-coup-de-grace]{Coup de Grace} or \nameref{man:Joint Thrust} attack, this weapon’s Thrust TN is decreased by 1. In addition, against mail armor this weapon gains AP Thrust 3. If the weapon has an AP Thrust quality, this replaces that value, it does not add to it.
...
The weapon gains an \hyperref[tab:Integrated Firearms]{Integrated Pistol} as
listed below. This pistol can be fired as a normal pistol. Alternatively, in the
event that you use a Swinging or Thrusting attack that hits an enemy, 1 CP can
be spent to make an immediate Melee Shoot attack on the target with BS from the
Swing or Thrust. This shot always hits in the same Hit Location as the Swing or
Thrust. Because of the bulk of the pistol, the weapon’s best Attack TN is
worsened by 1. If the Attack TNs are equal, you may choose which is worsened. 

This customization can be taken multiple times to represent a revolver-type
weapon, allowing the weapon to be fired multiple times before needing to be
reloaded. Additional purchases do not worsen the weapon’s Attack TNs further. 
...
The idea of designing a sword with a pistol built into it may sound like
fantasy, but if so, it’s the sort of fantasy that appealed to the medieval mind
enough for them to give it a shot. Integrated pistols usually fire in-line with
the blade, but a few are built into the crossguard, and fire forward from the
hand like regular pistols. Either way, they’re not very accurate and they tend
to make the weapon more cumbersome. However, they can be a huge advantage at
close range, or when closing with longer-ranged adversaries. 
\begin{table}[ht]
  \centering
...
\begin{quote}
  ...
  \hfill --\textit{Text of Krajini Bow Prohibition}
\end{quote}
...
Bludgeoning damage. The Bash TN is used in \nameref{man:Shield Bash}, and
similar Maneuvers. 
...
suffers damage (from a \nameref{man:Hew}~Maneuver, or similar source) equal to
its Durability, it is destroyed. Each time a shield sustains a
\nameref{man:Hew}~attempt that does not destroy it, its Durability is
...
weak spot in the armor. Weak spots can be targeted using the \nameref{man:Joint Thrust} Maneuver. 
...
Half-Plate Armor is that which covers about half of one's body in plate. This is
the sort of armor popular amongst infantry (such as the Rodeleros of Spain and
pikemen of various nations), and also that of mercenaries and noblemen who
dislike the weight of heavier armor. Helmet not included. 
...
The Fighting Volkodavs are a Dacian paramilitary organization formed by the
Colonial Sich Authority to range the Steppe. Officially, their mission is to
protect the colonies. Unofficially, their mission is to exterminate every living
thing in the Steppe that isn't a Dacian. The Marju steppelanders have long been
the enemy of Dace, and the Volkodavs were created to be the final resolution of
the feud. The Volkodavs wear armor intended for long deployment. The heavy quilt
keeps them warm on the freezing steppe, and combined with their chainmail coats,
they are virtually immune to arrows. Just in case, though, many of them also
wear a mirror plate on their chests. Volkodav armor is much cheaper than full
suits of plate, and much lighter. In the highly mobile environment of the
Infinite Steppe, this armor is invaluable. The Volkodavs wear special helmets,
Zischagges, with a movable visor (made to resemble a “hounskull,” a hound's
skull, or dog's face) visor, and intimidating wolf fur crests. You can get one
too, they're only 1 gp.  
...
\begin{longtabu}to \linewidth {X *{3}{X[-1,c]} X[2] X[2] *{3}{X[-1,c]}}
  ...
  Morion& 8& 7& 6& Lower Head*, Upper Head &\nameref{par:Hard}, +1 AV vs Downward Swings&1& 0& 12 sp\\
...
\paragraph[Enhanced Strength]{Enhanced Strength\footnote{Note: You can mix and
    ...
    enhancement levels cumulatively for the purposes of cost.} }---\quad[2+1 per level of STR] 
...
\nameref{man:grappling-coup-de-grace} Maneuvers from functioning against them.
% NEEDS REF TO WEAK POINTS  
...
A tank of oxygen that can be fed through the suit’s mask (or through a
mouthpiece if no mask is available) to allow breathing in environments with no
or dangerous air. The supply will last half an hour (additional air supplies can
be acquired for 1 augmentation slot, adding another 30 minutes.) 
...
The Burdinadin’s Natural Philosophy ability allows them to inspect devices and
materials on a level far deeper than anyone could do with their regular senses.
This lets them find weaknesses in steel, or inadequacies in construction that
would never be detected in a regular weapon until far too late. Burdinadin
craftsmen use this ability to find and remove these weaknesses during
construction. As a result, Burdinadin hardware is as close to flawless as it is
possible to be. Burdinadin weapons have +9 Durability and Burdinadin firearms
never break on a misfire. For swords and other melee weapons, this can be
combined with Fine Forging. 
...
An Electrified weapon is powered using a small copper turbine powered with a
pull-string. Once activated, which can be done at the same as drawing or
Quickdrawing a weapon, the weapon is Electrified for about ten seconds, or 5
Rounds. Any Maneuver that brings this weapon either in contact with the enemy
(such as Strike or Thrust), or in contact with a metal weapon that the enemy is
wielding (such as Parry), inflicts +4 Stun, regardless of whether or not the
attack inflicts damage. This does not work against the Undead.
...
\begin{longtabu} to \linewidth {*{8}{X[-1]}}
  ...
  \nameref{man:grappling-shoot-takedown}           & U &   & S & Grapple        & Attack       &           & X                                \\
  \nameref{man:grappling-trap}                     & U &   & S & Grapple        &              &                       & X                                \\
  \nameref{man:grappling-pin}                      & U &   &   & Grapple        &              &                       & X+2                              \\
  \nameref{man:grappling-subdue}                   & U &   & S & Grapple        & Initiative   &           & X+$\rfrac{1}{2}$ Opponent's STR \\
  \nameref{man:grappling-submission-hold}          & U &   & S & Grapple        & Initiative   &                       & X+1                              \\
  \nameref{man:grappling-limb-break}               & U &   & S & Grapple        & Initiative   &           & X                                \\
  \nameref{man:grappling-throttle}                 & U &   &   & Grapple        &              &            & X                                \\
  \nameref{man:grappling-coup-de-grace}            & U &   & S & Grapple        & Initiative   & Thrusting             & X+2                              \\
  \nameref{man:grappling-reap-takedown}            & U &   &   & Grapple        & Initiative   &           & X                                \\
  \nameref{man:grappling-suplex}                   & U &   & S & Grapple        & Initiative   &                       & X+3                              \\
  \nameref{man:grappling-toss}                     & U &   & S & Grapple        & Initiative   &           & X+2                              \\
  \nameref{man:grappling-slip}                     & U &   &   & Grapple        &              &           & X                                \\
  \nameref{man:grappling-twist}                    & U &   &   & Grapple        &              &           & X                                \\
  \nameref{man:grappling-bite}                     & U &   &   & Grapple        &              & Unarmed               & X+1                              \\
  \nameref{man:grappling-force}                    & U &   &   & Grapple        &              &           & X+2                              \\
  \nameref{man:grappling-pick-up}                  & U &   &   & Grapple        &              &           & X+$\rfrac{1}{2}$ Opponent's TOU \\
...
\end{description}
\begin{quotation}
  \emph{Vlatko rushes out of concealment to assassinate a Marju Khan, who has
    just left the bathhouse in a robe. He has a Pishkan Toothpick as his weapon,
    and declares a Dacian Rush. Vlatko has 15 CP. The Khan has 20 normally, but
    this Action he is surprised, and has only 10. Vlatko declares a Dacian Rush
    with 2+6+7 dice. The Khan tries to Quickdraw his saber by spending 1 CP, so
    that he can Parry the Dacian's knife with 8 dice.} 

  \emph{First the Khan must roll his PER (5) versus Vlatko's 6 dice, both at TN
    7. Vlatko succeeds by 1 BS, and in doing so inflicts 1 Stun, cancels the
    Khan's Quickdraw, and also his Parry, returning half of the dice spent (0
    from Quickdraw, 4 from the Parry) to his pool. Stun reduces this to 3,
    meaning the Khan only has 4 CP left. Vlatko now resolves his Thrust with 7
    dice, the Khan tries to use Quick Defense with an Arm Parry by spending 2
    and then defending with his remaining 2 dice. However, this Arm Parry is
    made at +2 TN (TN 9 for Arm Parry) meaning the Khan is less than likely to
    succeed. Vlatko gets 4 successes, the Khan gets 0. Vlatko inflicts
    STR+Weapon Damage+BS for 5+1+4 piercing damage to the Khan’s TOU of 5 and
    the AV of his clothing (ruled to be 1) inflicting a level 4 piercing Wound
    to the Belly through the Khan's robe. The Khan takes more damage than he can
    handle, and fails his Overshock test, becoming prone.} 

  \emph{Both parties have 0 CP left. If Vlatko had a few more dice, he could
    declare a Rapid Thrust to stab the man again, but instead he'll just wait
    for the Refresh to finish the injured warlord off.} 
\end{quotation}
...
\item [Success:] You and your Opponent are now
  \hyperref[sec:Grappling]{Grappling}. You regain [BS] CP. You are now Trapping %% Trap reference
...
\begin{itemize}
  ...
  \item During the Grapple, the Range of combat is locked at HA. Non-grapple
    Maneuvers can still be performed, but can be hindered by Traps or Pins. Any %% Ref to Trap/Pin
  ...
  \item If at any time both characters in a Grapple become Prone, the Grapple
    ...
    TN Penalty for being \nameref{par:Prone}, all other penalties still apply. 
  ...
  the Rapid Rise Maneuver. %% Rapid Rise reference
  ...
  at HA Reach. 
\end{itemize}
\item [Failure:] If Parried or Blocked, you suffer a Swing, Thrust, or Shield %% Needs ref to those maneuvers
...
See the \nameref{man:Clinch (Attack)} maneuver for more details on grappling.

\input{grappling-fix.tex}
...
\item [Hilt Push Maneuvers:] Push Maneuvers count as both attacks and defenses. When declaring a Hilt Push: 
  ...
  \item Hilt Push: \nameref{man:Thrust}
  \item Hilt Push: \nameref{man:Push Cut}
  \item Hilt Push: \nameref{man:Joint Thrust}
  \item Hilt Push: \nameref{man:Pommel Strike}*
  \item Hilt Push: \nameref{man:Disarm}*
  \item Hilt Push: \nameref{man:Clinch (Attack)}
  \item Hilt Push: \nameref{man:Butt-Strike}*
  \item Hilt Push: \nameref{man:Shoulder Charge}
  \end{itemize}
\end{description}
...
\item [Ride Fail:] You cannot convince your mount to bite anything this Action.
\end{description}
...
\paragraph{\label{par:Reload}Reload}---\quad Useful only for weapons like Firearms or Crossbows which must be loaded prior to being used, the Reload Action allows you to immediately utilize the \nameref{man:Reload} Maneuver. Moving incurs a -4 penalty to this Reload Roll.
...
For details on \nameref{sec:melee-combat}, see below.
...
\nameref{tab:Missile Target Zones}~table, and then roll again on the indicated
Thrusting Target Zone on the \nameref{tab:Hit Locations} table that your result
...
\subsection{Battlefield Terrain}\label{sec:battlefield-terrain}
...
\begin{table}
  \caption{Difficult Terrain RS}
  \label{tab:Difficult Terrain RS}
  \begin{tabu} spread 0pt {X[-1]X[-1]}
    Terrain &RS\\ \toprule
    Loose Gravel, Light Mud, Slippery Marble &4\\
    Deep Mud, Shallow Water, Potholes &6\\
    Collapsing Floor, Intense Mud, Deliberate Pitfalls &8\\
  \end{tabu}
\end{table}
...
\subsection{Outflanking}\label{sec:outflanking}
...
\subsection{Scatterfire}\label{sec:scatterfire} %SCATTERFIRE
...
play. A \nameref{skill:Surgery} check made at appropriate difficulty for wound level Treats the wound. Treated wounds 
...
\begin{table}[ht]
    ...
    d10 Result & Area Hit   & Toughness Limits & Adjacent Areas              \\ \toprule
    1          & Head       & 0                & Neck and Shoulder           \\
...
Example:
\begin{quotation} %% Example completely breaks down, fix it
...
\subsection{Burning \& Fire Damage} \label{sec:Fire}
When characters come into contact with fire, bad things tend to happen. Fire
damage is much simpler than damage from blunt, cutting, or piercing weapons. Its
table is generic, and any part of the body may suffer a Burn Wound using the
same chart, seen below.   
...
Cloth, Leather and other light armors do nothing to reduce burn damage. In fact,
they might make it worse (Quilted Armor, if worn without Plate over it,
increases the Burning Time of any Fire Damage by 1. Mail, Laminar, Brigandine,
...
Burning damage often lasts for multiple Rounds, inflicting damage at the
beginning of each, and clothing or armor may also catch fire, continuing the
blaze for still longer!  
...
\subsection{Cold Damage}\label{sec:Cold}
...
\marginpar {\hspace{-3em}\nameref{sec:upper-back}}\par
\marginpar {\hspace{-3em}\nameref{sec:lower-back}}
\begin{table}[!hb]
...
\end{table}
\clearpage
\section{Combat Factors}
\subsubsection{Conditions} \vspace{-10pt}
\nameref{par:Bleed}\\
\nameref{par:Pain}\\
\nameref{par:Stun}\\
\nameref{par:Prone}\\
\nameref{sec:outflanking}\\
\nameref{sec:exhaustion}
\subsubsection{Missile Weapons} \vspace{-10pt}
\nameref{par:Catch Chance}\\
\nameref{tab:Missile Target Zones}\\
\nameref{tab:Missile Attack Penalties}\\
\nameref{sec:scatterfire}\\
\nameref{sec:missile-attack}
\subsubsection{Alternate Damage Types} \vspace{-10pt}
\nameref{sec:Fire}\\
\nameref{sec:Cold}\\
\nameref{sec:Explosions}\\
\nameref{sec:falling-damage}
\subsubsection{Weapon Qualities} \vspace{-10pt}
\nameref{tab:Weapon Damage Threshold}\\
\nameref{tab:Reach}\\
\nameref{sec:weapons-special-qualities}\\
\nameref{tab:Default Matrix}
\subsubsection{Combat Stuff} \vspace{-10pt}
\nameref{sec:Grappling}\\
\hyperref[sec:combat-actions]{Combat Actions}\\
\nameref{tab:Round Structure}\\
\nameref{sec:mounted-combat}\\
\nameref{sec:battlefield-terrain}\\
\nameref{sec:maneuvers-list}
...
inflicted. Increase the RS of any \nameref{par:Stability}~test made to maintain
your grip on a weapon with this limb by the Wound level. %% WAIT WHAT THE FUCK DO YOU MEAN STABILITY TO MAINTAIN GRIP 
...
Automatically reduces Combat Pool to 0, and immediately renders you \nameref{par:Prone} without a test.
...
\section{Lower Back}\label{sec:lower-back}
