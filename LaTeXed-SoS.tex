...
\begin{longtabu} to 1.05\linewidth {X[2,l]	X	X[-1,c]X[-1,c]	XXX[-1,c]	X[2,l]	X[-3,c]X[-3,r]}
	\centering\\
	\caption{Daggers}\\
	\label{tab:Daggers List}\\
	\global\extrarowsep = 3mm
Weapon Name 					&Weapon Type	&Hands&Reach&Swing&Thrust&Defense (Guard)&Special						&Weight	&Cost\\\toprule
\endhead
