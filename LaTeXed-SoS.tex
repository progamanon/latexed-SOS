...
The Burdinadin’s HLT also factors into this.  
...
Any Maneuver Grapple with the Advantage tag may only be defended against using a Maneuver with the Disadvantage tag. See the \nameref{man:Clinch (Attack)} maneuver
