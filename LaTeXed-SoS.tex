...
\subparagraph{Entry Requirements:} 5 gp upon entry. Additionally, each Tier costs 5 gp to ‘unlock,’ as a member of a Noble School must pay exorbitant dues to his school in order to gain access to their secrets (this also serves to keep poor people out on the street, where they belong).
\subparagraph{Who Uses it:} Young aristocrats, the sons of very wealthy merchants, prodigious peasants allowed access because of natural talent.
\subparagraph{What Weapons:} Noble Schools tend to include civilized upper-class weapons, like long swords, sabers, lances, rapiers, and perhaps some missile weapons like bows or crossbows. Pugilism and wrestling are generally beneath the dignity of these men, but sometimes are included if dueling in armor is in vogue.
\subparagraph{Proficiencies:} 1-2 Primary [+2], 1-5 Secondary [+0] 
\subparagraph{Bonuses:} You automatically gain a Novice Talent for your Primary Proficiency at School level 1, a Journeyman Talent at level 5, and a Master Talent at level 10. You may also choose whether the Noble School you attended teaches Armored, Unarmored, or Missile fighting:
	\begin{description}
	...
	\end{description}
\subparagraph{Penalties:} None. You’re just superior. 
...
\subparagraph{Entry Requirements:} 10 sp upon entry, or 5 sp if the character served in an army, town guard, or militia. 
\subparagraph{Who Uses it:} Soldiers, mercenaries, civilian militia with training.
\subparagraph{What Weapons:} Soldier Schools can include a broad array of weapons, including swords, daggers, spears, maces, axes, bows, crossbows, javelins and slings, and as well as these, almost certainly including wrestling in their regimen. 
\subparagraph{Proficiencies:} 3-9 Primary [+0]
\subparagraph{Bonuses:} Tier 1 Maneuvers and Tier 2 Maneuvers cost 1 less for this School. 
\subparagraph{Penalties:} Mastery Maneuvers Tier costs 1 more for this School. 
\subparagraph{Cost:}[1]+1 per Proficiency at adoption.
...
Alternatively, flip a coin or roll for it. GMs, be sure to be consistent about this sort of thing!
%SIDE BY SIDE TARGET ZONES?
\newpage
\section{Target Zone Hit Locations}
\begin{table}[hb]
...
Level 4& 3& 12& 14& \nameref{Infection Risk}~+2& Deep penetration, organ damage, severe bleeding, serious risk of infection. \\
Level 5& 5& 16& 18& \nameref{Infection Risk}~+5& Extreme penetration, possible exit wound, organ and intestinal damage!\\
	\end{tabu}
\end{table}
...
Level 3& 5& 12& 10& \nameref{par:Infection Chance} +4 &Stabbed in the gut, organ and intestine damage. This is serious.\\
Level 4& 7& 14& 20& \nameref{par:Infection Chance} +4 &Severe internal damage. If this happened in a hospital today, your odds would be poor.\\
...
Level 4& 4& 12& 8& \nameref{Autodrop} &Severe damage to hand, 1-3 fingers severed, automatically drop held items.\\
Level 5& 5& 15& 15
	&\nameref{Autodrop}, \newline
		\nameref{par:Infection Risk} +5, \newline
		\nameref{par:Limb Severed}
...
Level 4& 5& 5& 0& \nameref{Autodrop} &Fractured bones in hand.\\
Level 5& 10& 10& 0& \nameref{Autodrop} &Broken fist.\\
	\end{tabu}
\end{table}
\clearpage
