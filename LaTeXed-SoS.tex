...
\begin{itemize}
\item [3:] You gain a +2 bonus to CHA when dealing with everyone, if your beauty is apparent. You gain a +4 bonus to CHA when dealing with characters who would find you sexually attractive.
\item [6:] You cause carriage crashes. You gain a +3 bonus to CHA when dealing with everyone, if your beauty is apparent. You gain a +6 bonus to CHA when dealing with characters who would find you sexually attractive. Beauty of this caliber often comes with unwanted attention.
\end{itemize}
...
\section{Master Talents}\label{sec:Master Talents}
 ...
 \paragraph{Leverage}
 \begin{description}
 \item [ Requirements: ]​ Wrestling, Ground Wrestler
