...
\usepackage{tabu,longtable,ctable}
	\tabulinesep = 1.2mm
\usepackage{fancyhdr}
\usepackage{lettrine}
...
\pagestyle{empty}
	...
	\vfill
	{\huge\LaTeX ified \today Revision of alpha version 0.1}\par
	\vspace{0.2 cm}
...
\subsection{Throwing Weapons} %THROWING WEAPONS SECTION
Explain how weapons are used/what is required for it.
...
Pit fighter/gladiator &Why is it easier to train a vicious man than a vicious dog? &20 gp\\
	\\
Exotic (feature) &Strange, but alluring features and language. &$ \text{Cost} \times 2 $\\
...
\vspace{-5pt}\begin{itemize}
	[itemsep=0.5mm]
	\item Upgrade an Unarmed Maneuver to Superior (choose three: Kick, Straight Punch, Hook Punch, Elbow, Knee, Shoulder Charge)
	\item One-Two Punch
\end{itemize}
...
Level 5& 10& 10& 0& \nameref{oar:Autodrop} &Broken fist.\\
	\end{tabu}
\end{table}
\clearpage
