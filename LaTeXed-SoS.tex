...
\section{Banes}
\paragraph{\label{bane:Arrow Magnet}}---\quad\textbf{ (3)}\par
...
\paragraph{\label{bane:Bad Ears}}---\quad\textbf{ (2/4)}\\
...
\paragraph{\label{bane:Bad Eyes }}---\quad\textbf{(4/6)}\\
\textit{Cannot be removed}\par
...
\paragraph{\label{bane:Bad Reputation }}---\quad\textbf{(3/6/9) }\par
...
of your reputation. 
\end{itemize}
\paragraph{\label{bane:Barren/Sterility}}---\quad\textbf{(1/3)}\\
...
\end{itemize}
\paragraph{\label{bane:Blind }}---\quad\textbf{(20)}
{Cannot be removed}\par
...
\paragraph{\label{bane:Braggart }}---\quad\textbf{(3)}\par
...
\begin{table}[!h]
	...
	\end{tabu}
\end{table}
\paragraph{\label{bane:Broken Limb/Appendage}}\quad\\
\textit{Cannot be removed}\par
...
\paragraph{\label{bane:Complete Monster }}---\quad\textbf{(10) }\par
...
\paragraph{\label{bane:Craven }}---\quad\textbf{(7/15) }\par
...
\paragraph{\label{bane:Crippled Limb/Appendage }}---\quad\textbf{(8)}\\
\textit{Cannot be removed}\par
...
\paragraph{\label{bane:Dead }}---\quad\textbf{(100) }\\
\textit{Cannot be removed}\par
You are dead. You may take no Actions except the Decompose Maneuver.
\paragraph{\label{bane:Debt }}---\quad\textbf{(2/4/8) }\par
...
\end{itemize}
\paragraph{\label{bane:Dependent }}---\quad\textbf{(6/12) }\par
...
\paragraph{\label{bane:Dire Past}}---\quad\textbf{(0) }\\
{Cannot be removed}\par
...
\paragraph{\label{bane:Enemies }}---\quad\textbf{(3/10/15) }\par
...
\end{itemize}
\paragraph{\label{bane:Facial Deformity }}---\quad\textbf{(2/4/8) }\\
\textit{Cannot be removed}\par
...
\end{itemize}
\paragraph{\label{bane:Fat }}---\quad\textbf{(5)}\par
...
\paragraph{\label{bane:Haemophilia }}---\quad\textbf{(8) }\\
\textit{Cannot be removed}\par
...
\paragraph{\label{bane:Hothead }}---\quad\textbf{(3) }\par
...
\paragraph{\label{bane:Honorable }}---\quad\textbf{(15) }\par
...
\paragraph{\label{bane:Lasting Pain }}---\quad\textbf{(4/8) }\\
{Cannot be removed}\par
...
\end{itemize}
\paragraph{\label{bane:Mute }}---\quad\textbf{(5/8) }\\
{Cannot be removed}\par
...
\end{itemize}
\paragraph{\label{bane:Oath }}---\quad\textbf{(2 to 10) }\par
...
\paragraph{\label{bane:Old Wound }}---\quad\textbf{(1) }\\
{Cannot be removed}\par
...
\paragraph{\label{bane:One-Eyed }}---\quad\textbf{(10) }\\
{Cannot be removed}\par
...
\paragraph{\label{bane:Poor }}---\quad\textbf{(4/6/8) }\par
...
\paragraph{\label{bane:Severed Limb/Appendage }}---\quad\textbf{(10/15/18) }\\
{Cannot be removed}\par
...
\paragraph{\label{bane:Sheltered }}---\quad\textbf{(2/4/6) }\par
...
\paragraph{\label{bane:Short}}---\quad\textbf{(8/15) }\par
...
\paragraph{\label{bane:Skinny }}---\quad\textbf{(3) }\par
...
\paragraph{\label{bane:Technologically Impaired }}---\quad\textbf{(5) }\par
...
\paragraph{\label{bane:Unhappily Married }}---\quad\textbf{(1/2/3) }\par
...
\end{itemize}
\paragraph{\label{bane:Virtuous }}---\quad\textbf{(10) }\par
...
\paragraph{\label{bane:Wanted }}---\quad\textbf{(5/10/15) }\par
