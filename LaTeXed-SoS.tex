...
\chapter{Six kingdoms of life?}%The sample chapter for the template
	\newpage
	...
	\begin{wrapfigure}{r}{0.36\textwidth}
		\centering
		\includegraphics[scale=0.35]{Descargas/mobot31753002356449_0113.jpg}
...
\begin{table}
	...
	\label{tab:AwardingArcPoints}
		\begin{tabu} spread 0pt {| X[c,m]X[l,m] |}\toprule %TABLE needs to be fixed, as the vertical lines are garbage
