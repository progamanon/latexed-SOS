...
\printcontents[chapters]{}{1}{}
\clearpage 
\section{Skills}%ALL the skills need tables, but I don't know how we want to lay that shit out
...
\begin{table}
	...
	\label{tab:Social Class Benefits}
