...
\begin{longtabu} spread 0pt{X[2,l]XX[-1,c]X[-1,c]XXX[-1,c]X[2,l]X[-3,c]X[-3,r]}
...
\subsection{1H Blunt}
\begin{tabu} to \linewidth{XXXX XXXX XX}
...
Table X.X Melee Weapon Special Qualities%USE table or just use a descriptive list?
