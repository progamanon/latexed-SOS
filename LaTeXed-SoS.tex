...
\begin{quote}
	\emph{Duke has been shot several times with a repeating crossbow. He is suffering 22 Blood Loss. He must make an Endurance test with his END of 5}
\end{quote}
...
Characters can attempt to staunch the loss of blood with the Surgery skill and whatever materials are at hand. A wound must be targeted with this skill which, if successful, terminates all Blood Loss from that wound.

If a Character goes for over an hour without losing a point of HLT, any remaining Blood Loss is automatically staunched, including Internal Bleeding.
...
[Optional]: If a character is knocked out while standing up or fighting, the GM may rule that he suffers Falling Damage due to landing on a hard surface or an object while unconscious. This usually will be equivalent of a fall from 6 feet. An unconscious man hitting an awkward surface (the corner of a table, a street curb, etc.) could suffer a far more severe injury than the actual blow that rendered him unconscious. 


Stability
When a character makes a Stability Test (either as specified by a wound or effect, or because their CP has been reduced to the negatives by Stun or Pain, or other reasons at GM’s discretion) roll an AGI test. The 
RS will vary depending on the cause of the event that called for a Stability Test. Failure renders the character Prone. 
...
The use of the Rapid-Rise Maneuver allows a character to stand up immediately upon falling down, if they have the remaining CP. Check \autoref{ch:Maneuvers} Proficiencies \& Manuevers for more information. 
...
Auto-Prone
You are automatically rendered Prone. You cannot Stand Up in the same action, or in the action 
...
Damage Charts
\section{Upper Head}
Table 8.1.4 Upper Head - Cutting Wound Level
Stun Pain Bleed Special Description 
...
Level 4 Total Total 8 Auto-KO [Difficult Surgery vs Brain Damage], Internal Bleeding Severe skull fracture, brain damage, immediate unconsciousness.
...
\section{Face}
Table 8.1.8 Face - Cutting Wound Level 
...
\section{Hip}
Table 8.1.36 Hip - Cutting Wound Level 
Stun Pain Bleed Special Description 
...
\section{Thigh}
Table 8.1.44 Thigh - Cutting Wound Level 
Stun Pain Bleed Special Description 
...
\section{Knee}
Table 8.1.48 Knee - Cutting Wound Level 
Stun Pain Bleed Special Description 
...
\section{Shin}
Table 8.1.52 Shin - Cutting Wound Level
Stun Pain Bleed Special Description 
...
\section{Upper Arm}
Table 8.1.60 Upper Arm - Cutting Wound Level 
Stun Pain Bleed Special Description 
...
\begin{table}%Lower Back Unarmed Wound
	\caption{Lower Back - Unarmed Wound}
	\label{tab:Lower Back Unarmed Wound}
