...
determines skill in a broad classification of weapon (for example, 1H Sword, a
2H Sword, and so on), not simply how effective a character is at wielding
certain instruments (such as a rapier, broadsword or  
...
are removed, preventing \nameref{man:Joint Thrust} and \nameref{man:Grappling:
  Coup de Grace} Maneuvers from functioning against them. %NEEDS REF TO WEAK POINTS 
...
Any Maneuver Grapple with the Advantage tag may only be defended against using a
Maneuver with the Disadvantage tag. See the \nameref{man:Clinch (Attack)}
maneuver 
...
\paragraph{\large Grappling: Bite}\label{man:Grappling: Bite}
---\quad{\large[X+1]}
\vspace{-10pt}\begin{description} 
\item [Type:] Universal, Grapple, Unarmed 
\item [Requirements:] Grappling. Must have teeth. Cannot have a visor or other
  armor covering the face. No hands required. You do not need to have Advantage
  to perform this Maneuver, but it resolves after the character with Advantage's
  Maneuver.  
